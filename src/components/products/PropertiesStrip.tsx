...
function ThermometerIcon() {
  return (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#C06830" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            >
              ...
              {i > 0 && (
                <div
                  ...
                  style={{ width: '0.5px', backgroundColor: '#8A9975' }}
                  aria-hidden="true"
                />
              )}
              <div className="mb-3">{prop.icon}</div>
              <span className="font-body text-loam-mid uppercase tracking-[0.12em] text-[10px] mb-1.5 leading-snug">
                {prop.label}
              </span>
              <span className="font-body font-normal text-loam text-sm">
                {prop.value}
              </span>
            </motion.div>
          ))}
